...
| **Nombre del Software:** | Sistema de Gestión de Calidad                         | **Versión:**    | [Número de versión]             |
| ------------------------ | ----------------------------------------------------- | --------------- | ------------------------------- |
| **Departamento:**        | Aseguramiento de calidad                              | **Licencia:**   | [Ej. GPL, MIT, Comercial, etc.] |
| **Operación:**           | [Ej. 8.5h × 5d, 24h × 7d, uso esporádico, etc.]       | **Relevancia:** | <br>⚫ Obsoleto  <br>            |
| **Descripción:**         | Gestión de requerimientos especiales y procedimientos |                 |                                 |
