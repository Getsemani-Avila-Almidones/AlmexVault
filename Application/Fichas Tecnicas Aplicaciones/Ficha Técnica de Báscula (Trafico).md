...
| **Nombre del Software:** | Bascula                                 | **Versión:**    | [Número de versión]             |
| ------------------------ | --------------------------------------- | --------------- | ------------------------------- |
| **Departamento:**        | Trafico                                 | **Licencia:**   | [Ej. GPL, MIT, Comercial, etc.] |
| **Operación:**           | uso esporádico                          | **Relevancia:** | <br>⚫ Obsoleto  <br>            |
